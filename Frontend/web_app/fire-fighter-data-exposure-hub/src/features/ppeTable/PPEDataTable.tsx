...
import { ppeColumns } from '@/features/ppeTable/columns'
import { DownloadPPECSVButton } from '@/features/ppeTable/DownloadPPECSVButton'

const PAGE_SIZE = 10

export function PPEDataTable() {
  ...
  const query = useQuery({
    queryKey: queryKeys.ppeTableData({
  ...
  const columns = useMemo(() => ppeColumns, [])
