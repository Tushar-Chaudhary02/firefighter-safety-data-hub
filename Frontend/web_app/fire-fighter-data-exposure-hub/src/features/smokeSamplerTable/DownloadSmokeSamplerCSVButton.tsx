...
import { downloadSmokeSamplerTableCSV } from '@/api/smokeSamplerTable.api'

export function DownloadSmokeSamplerCSVButton() {
  const mutation = useMutation({
    mutationFn: downloadSmokeSamplerTableCSV,
    onError: () => {
